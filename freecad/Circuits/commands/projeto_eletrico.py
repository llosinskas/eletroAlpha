...
import Part
import Draft
from freecad.Circuits.commands.eletro_libs import create_group
...
class ComponentEletric:
    ...
    def GetResources(self): 
        return {"Pixmap" :os.path.join(WB.ICON_PATH, 'Componentes.svg'),"MenuText": "Inserir um componente elétrico", "ToolTip":"Inserir um componente no projeto"}
...
class Gerar3D:  
    ...
    def GetResources(self):
        return {"Pixmap" : os.path.join(WB.ICON_PATH, "tomadas.svg"), "MenuText" : "Converter em 3D", "ToolTip":"Converter as informações inseridas em modelo 3D"}
